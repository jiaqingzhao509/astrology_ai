...
- Frame your answer to one of the following: ("potentially: which means murkier chances but not impossible", "unlikely: which means low chance", "very likely: indicating high confidence of happening" and "very unlikely: approaching 0 chances") based on your confidence when appropriate. 
- Answer using <120 words 
